  ...
  <body>
    ...
    <script>
      ...
      $(function() {
        ...
        $(".memo").click(function() {
          console.log($("#chattingFileForm").data("fileLink")); // 파일링크
          console.log($("#chattingFileForm").data("fileExtension")); // 이미지인지 확인하는 값
          if ($("#chattingFileForm").data("fileExtension") == "image") {
            socket.send(
              exeChat.imgMeg($("#chattingFileForm").data("fileLink"))
            );
          } else {
            socket.send(
              exeChat.fileMeg(
                "http://thumbnews.nateimg.co.kr/view610///news.nateimg.co.kr/orgImg/mt/2020/01/22/2020012209264741528_1.jpg"
              )
            );
          }
        });
